...
function settime() {
    ...
    if (wakeuptime == hours) {
        document.getElementsByClassName("right-bottom-container").style.backgroundImage = "url('./Assets/sunreal.png')";
        document.getElementsByClassName("right-bottom-container").innerText = "WAKE UP !!";
    }

    if (lunchtime == hours) {
        changeImage[0].style.backgroundImage = "url('./Assets/reallunch.png')";
        changeText[0].innerText = "LET'S HAVE SOME LUNCH !!";
    }

    if (naptime == hours) {
        changeImage[0].style.backgroundImage = "url('./Assets/realnap.png')";
